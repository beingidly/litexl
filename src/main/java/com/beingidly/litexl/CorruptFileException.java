...
public class CorruptFileException extends LitexlException {
    ...
    /**
     * Creates a corrupt file exception with the given detail.
     *
     * @param detail description of the corruption
     */
    ...
    /**
     * Creates a corrupt file exception with the given detail and cause.
     *
     * @param detail description of the corruption
